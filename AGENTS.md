# ABX Voice Assist Development Invariants

## One Installed Application

- The only runnable installed bundle is `/Applications/ABX Voice Assist.app`.
- Always use bundle identifier `com.abc.abxvoiceassist`.
- Local installation must atomically replace that bundle and restart only
  `com.abc.abxvoiceassist.agent`.
